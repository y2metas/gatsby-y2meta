        ...
        <section>
          <div className="md:py-8 py-6 text-center">
            ...
            <h3 className="text-lg text-justify	my-2.5">
              Y2meta هي أداة تنزيل YouTube مجانية تساعدك على تنزيل مقاطع فيديو YouTube بتنسيقات MP4 في بضع ثوان. إنها
              طريقة سريعة وسهلة لتنزيل مقاطع فيديو Mp4 من YouTube. قم بتنزيل أي فيديو على YouTube بأفضل جودة مختلفة مثل
              360p و 480 p و 720 p و 1080 p و 4K HD وما يصل إلى 8K.
            </h3>
            <h3 className="text-lg text-justify	my-2.5">
              باستخدام محول YouTube السريع والآمن هذا ، قم بتنزيل وحفظ فيديو YouTube بتنسيق MP4 و AVI و MOV على جهازك
              دون تسجيل. لا يهم ما إذا كنت تستخدم جهاز كمبيوتر شخصي أو جهاز لوحي أو iPhone أو هاتف Android. بالإضافة إلى
              ذلك ، يعمل برنامج تنزيل YouTube هذا على الويب ، لذا لا تحتاج إلى تثبيت برامج أو تطبيقات ، فهو يجعل التصفح
              أسهل كثيرًا.
            </h3>
          </div>
          ...
          <div
            ...
            <div>
              ...
              <div className="px-6 py-4">
                ...
                <p>
                  باستخدام هذا YouTube إلى MP4 ، قم بتنزيل مقاطع فيديو YouTube بقدر ما تريد. لا توجد قيود على الميزات
                  وعدد تنزيلات الفيديو من YouTube. أيضًا ، هذا مجاني تمامًا
                </p>
              </div>
            </div>
            <div>
              ...
              <div className="px-6 py-4">
                ...
                <p>
                  يجعل التداخل البسيط وسهل الاستخدام برنامج تنزيل YouTube MP4 هذا سهل الاستخدام. قم بتنزيل مقاطع فيديو
                  MP4 من YouTube بسرعة بخطوات بسيطة.
                </p>
              </div>
            </div>
            <div>
              ...
              <div className="px-6 py-4">
                ...
                <p>
                  إن محول YouTube إلى MP4 الخاص بنا آمن تمامًا مع طبقة SSL تساعد طبقة الأمان هذه على الحماية من
                  الفيروسات والبرامج الضارة ، لذلك لا تقلق بشأن ذلك. قم بتنزيل مقاطع فيديو YouTube بشكل آمن ومضمون
                  تمامًا
                </p>
              </div>
            </div>
            <div>
              ...
              <div className="px-6 py-4">
                ...
                <p>
                  محول YouTube إلى MP4 الخاص بنا هو تطبيق قائم على الويب لذا فهو يدعم جميع الأجهزة والمتصفح. لا تطلب
          ...
          <div className="md:py-8 py-6">
            ...
            <p>
              لا ، استخدام برنامج تنزيل YouTube هذا مجاني تمامًا ولن تحتاج إلى إنفاق أموال للتحويل. بالإضافة إلى ذلك ،
              لا توجد قيود على ميزات YouTube على MP4
            </p>
            ...
            <p>محول YouTube إلى MP4 الخاص بنا هو تطبيق قائم على الويب لذا فهو متوافق مع جميع الأجهزة والمتصفحات. لا تطلب
              تثبيت البرامج والتطبيقات</p>
          </div>
        </section>
      </div>
      <footer>
