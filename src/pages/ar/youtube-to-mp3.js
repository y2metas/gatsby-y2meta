        ...
        <section>
          <div className="md:py-8 py-6 text-center">
            ...
            <h3 className="text-lg text-justify	my-2.5">
              ...
              كيلوبت في الثانية و 128 كيلوبت في الثانية و 192 كيلوبت في الثانية وما يصل إلى 320 كيلوبت في الثانية.
            </h3>
            <h3 className="text-lg text-justify	my-2.5">
          ...
          <div className="md:py-8 py-6">
            ...
            <h3 className="mt-2.5 font-semibold">هل من الآمن تنزيل mp3 من YouTube باستخدام محول YouTube هذا؟</h3>
            <p>
